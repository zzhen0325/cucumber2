...
export function superInstructions(context?: CucumberAgentContext) {
  return [
    ...
    buildHostedWebSearchInstructions(context),
...
function buildHostedWebSearchInstructions(context?: CucumberAgentContext) {
  return supportsHostedWebSearchTool(context?.agentProvider)
