...
export const toolRegistry = {
  ...
  fetch_webpage: {
    id: "fetch_webpage",
    name: "fetch_webpage",
    traceLabel: "Fetch webpage",
    requiredScopes: ["write.artifact", "tool.web.fetch"],
  ...
  collect_research_sources: {
    ...
    traceLabel: "Collect research sources",
  ...
  create_research_artifact: {
    id: "create_research_artifact",
    name: "create_research_artifact",
    traceLabel: "Create research artifact",
    requiredScopes: ["write.artifact", "tool.research.answer"],
  ...
  image_matting: {
    id: "image_matting",
    name: "image_matting",
    traceLabel: "Image matting",
    requiredScopes: ["read.artifact", "write.artifact", "tool.image.matting"],
    producedArtifactTypes: ["image"],
    canCallExternalNetwork: true,
    inputSchema: {
      type: "object",
  ...
  decompose_image: {
    ...
    traceLabel: "Decompose image",
    requiredScopes: ["read.artifact", "write.artifact", "tool.image.decompose"],
    producedArtifactTypes: ["doc"],
    canCallExternalNetwork: false,
    inputSchema: {
      type: "object",
  ...
  analyze_media: {
    id: "analyze_media",
    name: "analyze_media",
    traceLabel: "Analyze media",
    requiredScopes: ["read.artifact", "write.artifact", "tool.media.analyze"],
    producedArtifactTypes: ["doc"],
    canCallExternalNetwork: false,
    inputSchema: {
      type: "object",
