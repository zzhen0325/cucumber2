...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-[12px] text-[14px] font-normal leading-[22px] tracking-normal whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/20 disabled:pointer-events-none disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-cuc-primary-hover hover:shadow-cuc-primary-hover active:bg-cuc-primary-active",
        destructive:
          "bg-destructive text-white  hover:bg-destructive/90 focus-visible:ring-destructive/20",
        outline:
          "border border-primary bg-transparent text-primary shadow-none hover:bg-primary/8 hover:text-cuc-primary-text-hover",
        secondary:
          "bg-secondary text-secondary-foreground shadow-none hover:bg-cuc-secondary-hover",
        ghost:
          "bg-cuc-ghost text-primary shadow-none hover:bg-cuc-ghost-hover hover:text-cuc-primary-text-hover",
