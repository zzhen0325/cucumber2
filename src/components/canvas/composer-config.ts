...
export const AGENT_PROVIDER_STORAGE_KEY = "cucumber:agent-provider";
...
export function readStoredAgentProvider(): AgentProviderSelection {
  if (typeof window === "undefined") {
    return "auto";
  }
  return readAgentProviderSelection(
    window.localStorage.getItem(AGENT_PROVIDER_STORAGE_KEY)
  );
}

export function readAgentProviderSelection(
