...
export const PROJECT_CARD_CLASS_NAME =
  "grid aspect-[286/208] min-w-0 grid-rows-[minmax(0,1fr)_auto_auto] gap-1.5 rounded-cuc-card border-[0.5px] border-cuc-border bg-cuc-surface p-2 text-left text-cuc-text shadow-none hover:border-cuc-node-border-strong max-[760px]:p-[7px]";
