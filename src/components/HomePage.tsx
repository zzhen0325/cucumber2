        ...
        >
          ...
          {!loading &&
            recentProjects.map((project) => (
              ...
              >
                <div className="aspect-[395/227] w-full overflow-hidden rounded-lg">
                  <div
...
function HomePrompt({ onSubmit }: { onSubmit: (prompt: string) => void }) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border-[0.5px] border-border bg-card shadow-[0_4px_8px_rgba(0,0,0,0.04)] sm:rounded-2xl">
      <textarea
        ref={textareaRef}
        value={value}
        ...
        rows={2}
        className="w-full resize-none bg-transparent px-3 pt-3 pb-2 text-sm leading-relaxed text-foreground placeholder:text-muted-foreground focus:outline-none sm:px-4 sm:pt-4"
      />

      <div className="flex items-center justify-end px-2 pb-2 sm:px-3 sm:pb-3">
        <button
          type="button"
